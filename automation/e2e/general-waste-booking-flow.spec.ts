...
import { generalWasteScenario as testData } from '../test-data/test-data'
...
test.describe('Complete booking flow — general waste, 4-yard skip', () => {
  test('Complete booking flow with general waste and 4-yard skip', async ({
    ...
    // Click address 'Northumberland Avenue'
    ...
    // Click 'General waste'
    await test.step("Click 'General waste'", async step => {
    ...
    // Click '4-yard' skip
    await test.step(`Click '${testData.skipSize}' skip`, async step => {
